namespace May.Siber.TestCase.Tests
{
	...
	public class UnitTest1
	{
		...
		public void ThreeBoxTest1()
		{
			var K = new int[] { 2, 1, 3 };
			//Böyle bir durumda tek koli hesaplamalý ve iki kutuyu tek koliye koymalý
			//Bu durumda kolinin boyutu 3x3 = 9 olmalý.
			var expected = 3 * 3;
			var actual = solution.solution(K);
			Assert.AreEqual(expected, actual);
		}
		...
		{
			var K = new int[] { 4, 3, 1 };
			//Böyle bir durumda iki koli hesaplamalý ve son iki kutuyu ikinci koliye koymalý
			//Bu durumda kolilerin toplam boyutu 4x1 + 3x2 = 4 + 6 = 10  olmalý.
